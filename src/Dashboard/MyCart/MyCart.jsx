  ...
  return (
    <div className="w-full">
     ...
     <div className="flex uppercase font-semibold justify-evenly items-center gap-4 mb-2">
        ...
        <button className="btn border-0  bg-[#D1A054]"   >Pay</button>
     </div>
      ...
      <tbody>
        {
            ...
            <th>
              <button onClick={()=>handleDelete(item)} className="btn bg-red-500 text-white border-0 "><FaTrashAlt></FaTrashAlt> </button>
            </th>
          </tr>
